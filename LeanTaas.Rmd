...
get_rs_ChildId<-function(parentid)
{
  ...
  parent_transaction<-release_transactions[transfer_transactions$transaction_id %in% parentid,]
  time_to_resolve<-difftime(child_ids[,"created_date"],release_transactions[,"created_date"],units = "days")
  return (time_to_resolve)
}
